...
export const socialLinks = [
    { name: "Github", icon: <Github size={20} />, href: "https://github.com/gc-marcos" },
    { name: "Linkedin", icon: <Linkedin size={20} />, href: "https://www.linkedin.com/in/gc-marcos" },
    { name: "Youtube", icon: <Youtube size={20} />, href: "https://www.youtube.com/@gc-marcos" },
    { name: "X", icon: <XIcon size={20} />, href: "https://x.com/gc_marcos1" },
];
...
export const services = [
    {
        ...
        description:
            "Atue com tecnologias web modernas para construir interfaces intuitivas e acessíveis, focando em usabilidade e impacto social.",
        features: [
    ...
    },
    {
        ...
        description:
            "Participe da criação de aplicativos móveis com foco em saúde e bem-estar, utilizando tecnologias híbridas e nativas.",
        features: [
    ...
    },
    {
        ...
        description:
            "Atue no desenvolvimento de aplicações completas, conectando frontend e backend com foco em soluções eficientes.",
        features: [
...
export const resumeData = {
    experience: [
        ...
        },
        {
            ...
            company: "Inoxplasma",
            description:
                "Atuei na otimização de processos logísticos de expedição e recebimento, integrando ERP para validação de pedidos e notas fiscais e utilizando Power BI para análise de estoque e monitoramento de indicadores. Meu foco em eficiência e precisão contribuiu para operações mais seguras e eficazes.",
        },
    ],
    education: [
        {
            ...
            description:
                "Graduando em Informática para Negócios, integrando tecnologia, dados e gestão para inovar nas organizações.",
        },
        {
            period: "2023 - 2024",
        ...
        },
        {
            ...
            description:
                "Técnico em Desenvolvimento de Sistemas, com foco em programação e banco de dados.",
        },
        {
            period: "2013 - 2016",
            ...
            institution: "Universidade Anhanguera",
            description:
                "Formado em Gestão da Produção Industrial, com foco em processos e produtividade.",
        },
    ],
    skills: [
...
export const skillsData = [
    ...
    { name: "Java", icon: "/skills/java.svg" }, // Corrigido de "Java.js"
...
export const projects = [
    ...
    },
    {
        ...
        description:
            "Aplicativo mobile Android que permite personalizar pedidos de hambúrguer, calcular o valor e enviar resumo por e-mail. Desenvolvido como prática do curso de Desenvolvimento Mobile.",
    ...
    },
    {
        ...
        description:
            "Site responsivo, com seções adaptativas, menu mobile, grid flexível e imagens otimizadas para diferentes tamanhos de tela.",
    ...
    },
    {
        ...
        description:
            "Aplicativo híbrido desenvolvido com Ionic e Angular para salvar e exibir dados localmente utilizando o Ionic Storage. Ideal para testes de persistência e prototipagem de formulários simples.",
